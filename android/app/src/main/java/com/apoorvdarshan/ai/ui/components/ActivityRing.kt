...
fun ActivityRing(
    ...
    // YAHAN TRACK COLOR KO GLASS UI KE HISAAB SE ADJUST KIYA
    val trackColor = glass.surfaceHover.copy(alpha = 0.4f) 
...
fun RingCenterLabel(primary: String, secondary: String) {
    ...
    Column(horizontalAlignment = Alignment.CenterHorizontally) {
        Text(
            ...
            color = glass.textPrimary // TEXT COLOR UPDATE KIYA
        )
        Text(
            secondary,
            style = MaterialTheme.typography.labelSmall,
            color = glass.textPrimary.copy(alpha = 0.6f) // SECONDARY TEXT UPDATE KIYA
        )
    }
}